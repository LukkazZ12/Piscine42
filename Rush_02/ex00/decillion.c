...
/*   Updated: 2022/07/24 10:30:12 by elais-be         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_decillion(char *str)
{
	int	j;
	int	k;

	j = 0;
	while (!(str[j] == '1' && str[j + 33] == '0'))
	{
		j++;
		if (str[j] == '1' && str[j + 33] == '0')
		{
			k = 0;
			while (k < 34)
			{
