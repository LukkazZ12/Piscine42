...
/*   Updated: 2022/07/24 10:30:47 by elais-be         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_nonillion(char *str)
{
	int	j;
	int	k;

	j = 0;
	while (!(str[j] == '1' && str[j + 30] == '0'))
	{
		j++;
		if (str[j] == '1' && str[j + 30] == '0')
		{
			k = 0;
			while (k < 31)
			{
